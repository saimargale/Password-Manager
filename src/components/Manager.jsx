...
const Manager = () => {
    ...
    const savePassword = () => {
        if(form.site.length >0 && form.username.length >0 &&form.password.length >7){
        ...
        <>
            ...
            <div className=" p-3 md:mycontainer min-h-[88.2vh] ">
                <h1 className='text-4xl text font-bold text-center'>
                    ...
                    <span className='text-white'>Pass</span><span className='text-purple-500'>Guard/&gt;</span>
                ...
                <div className="passwords">
                    <h2 className='font-bold text-purple-500 text-2xl py-4'>Your Passwords</h2>
                    {passwordArray.length === 0 && <div className='text-purple-500'> No passwords to show</div>}
